    ...
    <aside className={styles.sidebarContainer}>
      <nav>
        <ul className={styles.navList}>
          ...
          {/* Product Catalog */}
          <li className={styles.navItem}>
            <Link href="/merchant/product/" className={styles.navLink}>
          ...
          {/* Product Templates */}
          <li className={styles.navItem}>
            <Link href="/merchant/producttemplates" className={styles.navLink}>
          ...
          {/* Store Connect */}
          <li className={styles.navItem}>
            <Link href="/merchant/storeconnect" className={styles.navLink}>
              <Icon source={StoreIcon} />
          ...
          {/* Mockup Generator */}
          <li className={styles.navItem}>
            <Link href="/merchant/mockup" className={styles.navLink}>
              <Icon source={StoreIcon} />
          ...
          {/* Store Credits */}
          <li className={styles.navItem}>
            <Link href="/merchant/storecredit" className={styles.navLink}>
              <Icon source={StoreIcon} />
          ...
          {/* Custom Branding */}
          <li className={styles.navItem}>
            <Link href="/merchant/custombranding" className={styles.navLink}>
              <Icon source={StoreIcon} />
          ...
          {/* Resources */}
          <li className={styles.navItem}>
            <Link href="/merchant/resources" className={styles.navLink}>
